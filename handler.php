...
$mail_to_email = 'mj@nextmilestone.io'; // your email
...
try {
	...
	echo 'Your message has been sent to Next Milestone';

} catch (Exception $e) {

	echo "Your message could not be sent to Next Milestone. Mailer Error: {$mail->ErrorInfo}";
